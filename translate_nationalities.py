...
TRANSLATIONS = {
    ...
    "Anglo-Canadian": {"hu": "angol-kanadai", "es": "angloc anadiense", "fr": "anglo-canadien", "de": "anglokanadisch", "cs": "anglokanadský", "uk": "англо-канадський", "it": "anglo-canadese", "hr": "anglokanadski", "pl": "anglokanadyjski", "ru": "англоканадский", "nl": "Angelsaksisch-Canadees"},
    "Anglo-French": {"hu": "angol-francia", "es": "angl ofrancés", "fr": "anglo-français", "de": "anglofranzösisch", "cs": "anglofrancouzský", "uk": "англо-французький", "it": "anglo-francese", "hr": "anglofrancuski", "pl": "anglofrancuski", "ru": "англо-французский", "nl": "Anglo-Frans"},
    "Anglo-Welsh": {"hu": "angol-walesi", "es": "angal galés", "fr": "anglo-gallois", "de": "anglowalisisch", "cs": "anglowelšský", "uk": "англо-валлійський", "it": "anglo-gallese", "hr": "anglovelški", "pl": "anglowalijski", "ru": "англо-валлийский", "nl": "Anglo-Welsh"},
    ...
    "Argentinean": {"hu": "argentin", "es": "argentino", "fr": "argentin", "de": "argentinisch", "cs": "argentinský", "uk": "аргентинський", "it": "argentino", "hr": "argentinski", "pl": "argentyński", "ru": "аргентинский", "nl": "Argentijns"},
    ...
    "Austro-Hungarian": {"hu": "osztrák-magyar", "es": "austrohúngaro", "fr": "austro-hongrois", "de": "österreichisch-ungarisch", "cs": "rakousko-uherský", "uk": "австро-угорський", "it": "austro-ungarico", "hr": "austro-ugarski", "pl": "austro-węgierski", "ru": "австро-венгерский", "nl": "Oostenrijks-Hongaars"},
    ...
    "Benedictine": {"hu": "bencés", "es": "benedictino", "fr": "bénédictin", "de": "benediktinisch", "cs": "benediktinský", "uk": "бенедиктинський", "it": "benedettino", "hr": "benediktinski", "pl": "benedyktyński", "ru": "бенедиктинский", "nl": "benedictijns"},
    ...
    "Czechoslovak": {"hu": "csehszlovák", "es": "checoslovaco", "fr": "tchécoslovaque", "de": "tschechoslowakisch", "cs": "československý", "uk": "чехословацький", "it": "cecoslovacco", "hr": "čehoslovački", "pl": "czechosłowacki", "ru": "чехословацкий", "nl": "Tsjecho-Slowaaks"},
    ...
    "English or French": {"hu": "angol vagy francia", "es": "inglés o francés", "fr": "anglais ou français", "de": "englisch oder französisch", "cs": "anglický nebo francouzský", "uk": "англійський або французький", "it": "inglese o francese", "hr": "engleski ili francuski", "pl": "angielski lub francuski", "ru": "английский или французский", "nl": "Engels of Frans"},
    ...
    "Franco-Ecuadorian": {"hu": "francia-ecuadori", "es": "francoecuatoriano", "fr": "franco-équatorien", "de": "französisch-ecuadorianisch", "cs": "francouzsko-ekvádorský", "uk": "французько-еквадорський", "it": "franco-ecuadoriano", "hr": "francusko-ekvadorski", "pl": "francusko-ekwadorski", "ru": "франко-эквадорский", "nl": "Frans-Ecuadoraans"},
    ...
    "Franco-Flemish-German": {"hu": "francia-flamand-német", "es": "francoflamenco-alemán", "fr": "franco-flamand-allemand", "de": "französisch-flämisch-deutsch", "cs": "francouzsko-vlámsko-německý", "uk": "французько-фламандсько-німецький", "it": "franco-fiammingo-tedesco", "hr": "francusko-flamansko-njemački", "pl": "francusko-flamandzko-niemiecki", "ru": "франко-фламандско-немецкий", "nl": "Frans-Vlaams-Duits"},
    ...
    "French or Burgundian": {"hu": "francia vagy burgundiai", "es": "francés o borgoñón", "fr": "français ou bourguignon", "de": "französisch oder burgundisch", "cs": "francouzský nebo burgundský", "uk": "французький або бургундський", "it": "francese o borgognone", "hr": "francuski ili burgundski", "pl": "francuski lub burgundzki", "ru": "французский или бургундский", "nl": "Frans of Bourgondisch"},
    "French or Flemish": {"hu": "francia vagy flamand", "es": "francés o flamenco", "fr": "français ou flamand", "de": "französisch oder flämisch", "cs": "francouzský nebo vlámský", "uk": "французький або фламандський", "it": "francese o fiammingo", "hr": "francuski ili flamanski", "pl": "francuski lub flamandzki", "ru": "французский или фламандский", "nl": "Frans of Vlaams"},
    ...
    "Luxembourgian": {"hu": "luxemburgi", "es": "luxemburgués", "fr": "luxembourgeois", "de": "luxemburgisch", "cs": "lucemburský", "uk": "люксембурзький", "it": "lussemburghese", "hr": "luksemburški", "pl": "luksemburski", "ru": "люксембургский", "nl": "Luxemburgs"},
    ...
    "Persian": {"hu": "perzsa", "es": "persa", "fr": "persan", "de": "persisch", "cs": "perský", "uk": "перський", "it": "persiano", "hr": "perzijski", "pl": "perski", "ru": "персидский", "nl": "Perzisch"},
    ...
    "Philippine": {"hu": "fülöp-szigeteki", "es": "filipino", "fr": "philippin", "de": "philippinisch", "cs": "filipínský", "uk": "філіппінський", "it": "filippino", "hr": "filipinski", "pl": "filipiński", "ru": "филиппинский", "nl": "Filipijns"},
    ...
    "Prussian": {"hu": "porosz", "es": "prusiano", "fr": "prussien", "de": "preußisch", "cs": "pruský", "uk": "прусський", "it": "prussiano", "hr": "pruski", "pl": "pruski", "ru": "прусский", "nl": "Pruisisch"},
    ...
    "Western": {"hu": "nyugati", "es": "occidental", "fr": "occidental", "de": "westlich", "cs": "západní", "uk": "західний", "it": "occidentale", "hr": "zapadni", "pl": "zachodni", "ru": "западный", "nl": "westers"},
    "Yugoslav": {"hu": "jugoszláv", "es": "yugoslavo", "fr": "yougoslave", "de": "jugoslawisch", "cs": "jugoslávský", "uk": "югославський", "it": "jugoslavo", "hr": "jugoslavenski", "pl": "jugosłowiański", "ru": "югославский", "nl": "Joegoslavisch"},
}
